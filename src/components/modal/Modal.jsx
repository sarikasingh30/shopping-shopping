                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 " style={{ backgroundColor: theme === 'dark' ? '#B0A695' : '#F3EEEA'}}>
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={ closeModal} type="button" className="focus:outline-none w-full  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 "  style={{backgroundColor:theme==="dark" ? "rgb(59, 152, 245)":"rgb(250 204 21)", color:theme==="dark"?"white":"black"}}>Order Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
