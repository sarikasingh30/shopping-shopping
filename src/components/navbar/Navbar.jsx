            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link to={'/order'} className="text-sm font-medium text-black " style={{ color: theme === 'dark' ? 'white' : '', }}>
                    Order
                  </Link>
                  <Link to={'/dashboard'} className="text-sm font-medium text-black " style={{ color: theme === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link>

                  <a className="text-sm font-medium text-black cursor-pointer  " style={{ color: theme === 'dark' ? 'white' : '', }}>
                    Logout
                  </a>
                </div>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/cart'} className="group -m-2 flex items-center p-2" style={{ color: theme === 'dark' ? 'white' : '', }}>
                    ...
                    <span className="ml-2 text-sm font-medium text-black group-" style={{ color: theme === 'dark' ? 'white' : '', }}>0</span>
