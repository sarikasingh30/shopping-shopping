...
export const ProductInfo = () => {
  ...
  const getProductData = async () => {
    setLoading(true);
    try {
      const productDetail = await getDoc(doc(fireDB, "products", params.id));
      setPro(productDetail.data());
      setLoading(false);
    } catch (error) {
      console.log(error);
      setLoading(false);
        ...
        <div className="container px-5 py-32 mx-auto">
          {pro && (
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              <img
                alt="ecommerce"
                className="lg:w-1/2 w-full lg:h-auto object-cover object-center rounded md:w-1/2 "
                src={pro.imageUrl}
              />
